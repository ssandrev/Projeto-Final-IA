...
public class CasoTeste2 {
	...
	public CasoTeste2(){
		...
		// linha 1 2
		horario[0][0].setMateria(0, Cores.ANSI_BLACK + "COMP0409"+ Cores.ANSI_RESET);
		horario[1][0].setMateria(0, Cores.ANSI_BLACK + "COMP0409"+ Cores.ANSI_RESET);
		horario[0][2].setMateria(0, Cores.ANSI_BLACK + "COMP0409"+ Cores.ANSI_RESET);
		horario[1][2].setMateria(0, Cores.ANSI_BLACK + "COMP0409"+ Cores.ANSI_RESET);
		...
		horario[0][4].setMateria(0, Cores.ANSI_BLACK + "COMP0438"+ Cores.ANSI_RESET);
		horario[1][4].setMateria(0, Cores.ANSI_BLACK + "COMP0438"+ Cores.ANSI_RESET);
		
		horario[0][4].setHoras(0);
		horario[1][4].setHoras(0);
		
		// linha 3 4
		horario[2][4].setMateria(0, Cores.ANSI_BLACK + "COMP0438"+ Cores.ANSI_RESET);
		horario[3][4].setMateria(0, Cores.ANSI_BLACK + "COMP0438"+ Cores.ANSI_RESET);
		
		horario[2][4].setHoras(0);
		horario[3][4].setHoras(0);
		
		
		horario[2][1].setMateria(0, Cores.ANSI_BLACK + "COMP0412"+ Cores.ANSI_RESET);
		horario[3][1].setMateria(0, Cores.ANSI_BLACK + "COMP0412"+ Cores.ANSI_RESET);
		horario[2][3].setMateria(0, Cores.ANSI_BLACK + "COMP0412"+ Cores.ANSI_RESET);
		horario[3][3].setMateria(0, Cores.ANSI_BLACK + "COMP0412"+ Cores.ANSI_RESET);
		...
		// linha 5 6
		horario[4][0].setMateria(0, Cores.ANSI_BLACK + "COMP0408"+ Cores.ANSI_RESET);
		horario[5][0].setMateria(0, Cores.ANSI_BLACK + "COMP0408"+ Cores.ANSI_RESET);
		horario[4][2].setMateria(0, Cores.ANSI_BLACK + "COMP0408"+ Cores.ANSI_RESET);
		horario[5][2].setMateria(0, Cores.ANSI_BLACK + "COMP0408"+ Cores.ANSI_RESET);
		...
		// linha 8 9
		horario[7][0].setMateria(0, Cores.ANSI_BLACK + "COMP0461"+ Cores.ANSI_RESET);
		horario[8][0].setMateria(0, Cores.ANSI_BLACK + "COMP0461"+ Cores.ANSI_RESET);
		horario[7][2].setMateria(0, Cores.ANSI_BLACK + "COMP0461"+ Cores.ANSI_RESET);
		horario[8][2].setMateria(0, Cores.ANSI_BLACK + "COMP0461"+ Cores.ANSI_RESET);
